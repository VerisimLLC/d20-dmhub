            ...
            gui.Panel{
                ...
                gui.Panel{
                    ...
                    refreshDescription = function(element, race, subrace, nofire)
                        ...
                        local heightDescription = ""
                        if GameSystem.RacesHaveHeights then
                            heightDescription = string.format(tr("stand around %s feet tall, and "), json(race.height))
                        end

                        local textItems = {
                            string.format(tr("<b>Size.</b>  Your people %sare size %s creatures."), heightDescription, race.size),
                            string.format(tr("<b>Speed.</b>  Your base walking speed is "), MeasurementSystem.NativeToDisplayStringWithUnits(race.moveSpeeds.walk)),
                        }
