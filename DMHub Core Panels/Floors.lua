...
CreateLayersPanel = function()
	...
	floorsList = gui.Panel{
		...
		refreshGame = function(element)
			...
			local children = {CreateDragTarget(#currentMap.floors+1)}

			if currentMap.groundLevel == #currentMap.floors+1 then
				children[#children+1] = groundLevelPanel
				children[#children+1] = CreateDragTarget(#currentMap.floors+1, true)
			end
						...
						local icons = gui.Panel{
							...
							gui.Panel{
								...
								gui.Panel{
									...
									bgimage = cond(floor.floorInvisible, 'icons/icon_tool/icon_tool_60.png', 'icons/icon_tool/icon_tool_59.png'),

									refreshGame = function(element)
										element.bgimage = cond(floor.floorInvisible, 'icons/icon_tool/icon_tool_60.png', 'icons/icon_tool/icon_tool_59.png')
	...
	local aspect = (dmhub.screenDimensions.y/dmhub.screenDimensions.x) / (1080/1920)
