                            ...
                            layout = function(element, layout)
                                ...
                                for _,rect in ipairs(layout.mergedRects) do
                                    if rect.a <= startingCharIndex and rect.b >= startingCharIndex then
                                        ...
                                        text = text:sub(1, startPos-1) .. "<b>" .. text:sub(startPos, endPos) .. "</b>" .. text:sub(endPos+1)
...
--                },
                ...
                gui.SettingsButton{
                    ...
                    press = function(element)
                        if element.data.settingsDialog ~= nil then
                            if element.data.settingsDialog.valid then
                    ...
                    highlight = function(element, rects, text)
                        ...
                        for i,r in ipairs(rects or {}) do
                            ...
                            if fromSearch then
                                ...
                                --local scrollPosition = clamp(desiredCenter / (element.renderedHeight - element.parent.renderedHeight), 0, 1)
