...
local FieldsPanel = function(fields, options)
	...
	for _,entry in ipairs(entries) do
		local typeid = string.gsub(string.lower(entry.type), " ", "")
			...
			documentationPanel:AddChild(
				CollapsibleSectionPanel{
					...
					content = {
						...
						gui.Label{
							fontSize = 16,
							text = string.format("%s is the subject of the script. Any of its fields can be used directly as terms within the script.", options.documentation.subjectDescription),
							width = "100%",
							height = "auto",
							textWrap = true,
							halign = "left",
				...
				documentationPanel:AddChild(
					CollapsibleSectionPanel{
						...
						content = {
							...
							gui.Label{
								fontSize = 16,
								text = "In addition to the subject, this GoblinScript can use the following situational fields as terms within the script.",
								width = "100%",
								height = "auto",
								textWrap = true,
								halign = "left",
