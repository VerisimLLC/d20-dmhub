...
--- @field GetSelectedMonster fun(): string|nil A function that can be set to tell the engine which bestiary entry monster is selected. Returns a string representing the id of the bestiary entry.
...
--- @param args {shape: SpellShapes, token: CharacterToken, targetPoint: Vector3, range: nil|number, radius: nil|number, locOverride: nil|Loc, requireEmpty: nil|boolean }
--- @return LuaShape
